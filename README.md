...
Yohhan Kumarasinghe*, Jacob Williams*, Yuxin Yuan, Wenbo Wang, Julie-Alexia Dias, Haoyu Zhang, Zilin Li<sup>#</sup>, & Xihao Li<sup>#</sup>. (2026). **MetaSTAARlite: an all-in-one tool for biobank-scale whole-genome sequencing meta-analysis**. _Nature Computational Science_. DOI: <a href="https://doi.org/10.1038/s43588-026-00995-x">10.1038/s43588-026-00995-x</a>.
