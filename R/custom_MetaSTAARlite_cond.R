#' Performs meta-analysis of custom functional categories using MetaSTAAR
#'
#' This function performs meta-analysis to detect associations between a
#' quantitative/dichotomous phenotype and coding functional categories of a gene by using the MetaSTAAR procedure.
...
#' @param mask_name a character which specifies the name of the mask to be meta-analyzed using the MetaSTAAR procedure.
...
#' @param coding_cov_gene_list a list containing study-specific sparse weighted covariance matrices corresponding to the custom mask.
#' @param custom_cov_cond_mask_list a list containing the names of the variants to condition on
