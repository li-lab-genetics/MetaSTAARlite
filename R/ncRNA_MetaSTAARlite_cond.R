#' Performs conditional meta-analysis of ncRNA functional categories using MetaSTAAR
#'
...
#' @param ncRNA_cov_gene_list a list containing study-specific sparse weighted covariance matrices corresponding to the specified gene.
#' @param ncRNA_cov_cond_gene_list a list containing the variants to be conditioned on
...
#' @param variant_type type of variant included in the analysis. Choices include "SNV", "Indel", or "variant".
